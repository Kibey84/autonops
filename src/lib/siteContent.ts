...
export const siteContent: ContentSection[] = [
  ...
  },
  {
    ...
    url: '/about',
    title: 'About AutonOps',
    section: 'Leadership - Joshua Kibe',
    content: `Joshua Kibe, PMP is the Chief Financial Officer (CFO) of AutonOps. He is a Project Management Professional and retired U.S. Air Force veteran with more than 20 years of experience leading mission-critical operations, aircraft support, and complex programs in high-risk, time-sensitive environments. At AutonOps, he serves as CFO and one of the company's first operational pilots, bringing a rare blend of hands-on mission execution and disciplined financial governance. Josh oversees financial strategy, budgeting, pricing, invoicing, and profitability analysis for AutonOps. He is also an FAA Part 107 certified remote pilot.`,
  },
  {
    page: 'about',
    url: '/about',
    title: 'About AutonOps',
    section: 'Leadership - Jaderic Dawson',
    content: `Jaderic Dawson, M.S. is the Chief Technology Officer (CTO) of AutonOps. He is a mechanical engineer, AI architect, and FAA Part 107 certified remote pilot with more than a decade of experience designing and deploying advanced artificial intelligence systems in operational, mission-critical environments. At AutonOps, Jaderic serves as CTO and one of the company's original operational pilots, bridging autonomous systems, real-world flight operations, and decision-support technology. He leads the development of AI-enabled mission systems that integrate sensor feeds, autonomy, and real-time analytics into the mission control environment. His expertise spans multi-modal sensor integration, real-time edge computing, predictive modeling, and human-in-the-loop AI frameworks. He holds a Master of Science in Mechanical Engineering with a concentration in intelligent systems.`,
  },
  {
    page: 'about',
    url: '/about',
    title: 'About AutonOps',
    section: 'Leadership Team Summary',
    content: `AutonOps leadership team: Bob Lee is Co-Founder and CEO (expertise in defense electronics, DARPA, AI platforms). Matthew B. Sunday is Co-Founder and COO (30+ years operations, military veteran). Joshua Kibe, PMP is the CFO and operational pilot (Air Force veteran, financial governance, Part 107 pilot). Jaderic Dawson, M.S. is the CTO and operational pilot (AI architect, mechanical engineer, Part 107 pilot). Contact the leadership team through the website or at bob.lee@autonops.us.`,
  },
  {
    page: 'about',
    url: '/about',
